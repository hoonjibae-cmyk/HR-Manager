...
export const OVERSEAS_PROCESSORS: Array<{
  ...
  },
  {
    ...
    purpose:
      "연차·보강 일정 공유(구글 캘린더), 업무 문서·근로계약서 서명본 보관·공유(구글 드라이브), " +
      "급여명세서 등 문서의 이메일 발송(지메일)",
    items:
      "성명, 이메일 주소, 휴가·보강 일자, 급여명세서에 기재된 급여·공제 내역, " +
      "근로계약서 서명본에 기재된 인적사항(주소·연락처 등), 업무 문서에 포함되는 개인정보",
  },
  {
