...
export const IMPORT_COLUMNS: Array<{ key: string; header: string; alias: string[]; note?: string }> = [
  ...
  { key: "baseWage", header: "기본급", alias: ["월기본급", "시급", "기본급(시급)"] },
  { key: "positionAllow", header: "직책수당", alias: ["직책 수당"] },
  { key: "mealAllow", header: "식대", alias: ["식대(비과세)", "중식대"] },
  { key: "carAllow", header: "차량유지비", alias: ["차량유지비(비과세)", "자가운전보조금"] },
