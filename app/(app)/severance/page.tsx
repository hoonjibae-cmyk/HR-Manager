    ...
    <div className="flex flex-col h-[calc(100dvh-6rem)] min-h-[28rem]">
      ...
      <details className="mt-4 text-xs text-slate-400">
        ...
        <div className="mt-2 leading-relaxed space-y-1.5">
          ...
          <p>
            · <b>산정기준 임금</b> — 기본급·주휴수당·직책수당·식대·차량유지비·연차미사용수당이
            들어가고, <b>상여·인센티브·오버타임 수당은 빠집니다</b>(산정 조건에서 변경 가능).
            월 적립액 = 산정기준 임금 ÷ 12, 원 단위 반올림(10원 절사하지 않습니다 — 근로자 몫이라
            깎지 않습니다).
          </p>
          <p>
          ...
          <p className="text-amber-600">
            ...
            이고, 연장·야간·휴일수당도 근로의 대가인 임금에 들어갑니다. 이들을 빼는 현재 기준으로는
            하한에 미달할 수 있으니 노무 자문으로 확인해 주세요. 산입하려면{" "}
            <b>산정 조건</b>에서 켜면 됩니다.
          </p>
        </div>
      </details>
