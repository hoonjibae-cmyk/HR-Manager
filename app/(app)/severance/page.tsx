      ...
      <details className="mt-4 text-xs text-slate-400">
        ...
        <div className="mt-2 leading-relaxed space-y-1.5">
          ...
          <p>
            ...
            <b>입사일부터 전체 기간</b>에 대해 지급 의무가 생기므로(§8①), DC 가입 시{" "}
            <b>소급 납입</b>해야 합니다(표의 「소급」 표시).
          </p>
          <p>
            · <b>적립 누계</b> — 재직자 전체가 지금까지 쌓은 충당금과 DC 부담금의 합입니다.
            직원 정보에서 <b>퇴직정산 완료</b>를 체크한 직원(이미 지급·납입을 끝낸 경우)은 이
            집계에서 빠지고, 표의 누계 칸에 「정산 완료」로 표시됩니다.
          </p>
          <p>
          ...
          <p>
            · <b>기준급여는 세 곳에서 온다</b> — <b>지정</b>(관리자가 직접 정한 값) &gt;{" "}
            <b>그 달 급여</b> &gt; <b>추산</b>(급여 레코드가 없던 달을 계약 이력에서 추산한 값).
            지정·추산은 금액 옆에 배지로 표시됩니다. 행을 눌러 <b>기준급여 수정</b>으로 언제든
            직접 정할 수 있고, <b>지정 해제</b>하면 급여(또는 추산) 기준으로 되돌아갑니다.
          </p>
          <p>
            · <b>추산은 만근 가정</b>입니다 — 그 달을 지배한 계약의 월 급여총액을 쓰고,
            입·퇴사월만 일할계산합니다. 결근·그 달만의 조정은 반영되지 않으므로, 실제와 다르면
            기준급여를 직접 고쳐 주세요. 나중에 그 달 급여가 산정되면 <b>급여가 추산을 이깁니다</b>
            (추산값을 지울 필요가 없습니다).
          </p>
          <p>
