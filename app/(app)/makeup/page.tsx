...
export default async function MakeupPage({
  ...
  return (
    <div>
      <PageHeader
        title="보강 · 오버타임"
        desc="슬랙 신청(보강·주말근무·평일 초과근무) → 신청자가 실근무 시간 확정(직원 근무는 사후 등록 시 즉시 확정) → 오버타임 수당 자동 산출 → 급여명세서 반영"
      ...
      <p className="text-xs text-slate-400 mt-4 leading-relaxed">
        ...
        · <b>주말근무·평일 초과근무</b>(🗓)는 교수부가 아닌 직원의 근무 신청이다 — 같은 슬랙
        입구에서 근무 날짜가 토·일·공휴일이면 주말근무, 평일이면 평일 초과근무로 자동 구분된다.
        보강이 아니라서 보강캘린더에는 올라가지 않는다 &nbsp;
        · 직원 근무는 <b>끝난 뒤에 등록해도 된다</b>(평일 초과근무는 미리 예측할 수 없어 사후
        등록이 보통이다) — 이미 끝난 근무를 등록하면 적은 시간이 그대로 실근무로 즉시 확정된다.
        급여 마감(다음 달 1일)이 지난 건은 등록만 되고 관리자가 확정해야 한다 &nbsp;
